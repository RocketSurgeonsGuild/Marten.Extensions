...
namespace Rocket.Surgery.Extensions.Marten.Functions
{
    ...
    [UsedImplicitly]
    internal class MartenFunctionFilter : IFunctionInvocationFilter, IFunctionExceptionFilter
    {
        ...
        public MartenFunctionFilter(IDocumentSession documentSession) => _documentSession = documentSession;
